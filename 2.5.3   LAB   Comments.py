...
print("Goodbye")#here we should also print "Goodbye"

hours = 3
print( "Hours: ", hours, "\nSeconds in Hours: ", hours * seconds)#this is the end of the program that computes the number of seconds in 3 hour